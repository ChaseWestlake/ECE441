...
HD_PWD='C:/Users/alymooltazeem/Documents/ECE441/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kogge_stone_adder_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kogge_stone_adder_8bit.tcl -notrace
