...
##Switches vgaRedIn, vgaBlueIn, vgaGreenIn
...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports {vgaBlueIn[0] }]; #IO_L24N_T3_34 Sch=sw[8]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports {vgaBlueIn[1] }]; #IO_25_34 Sch=sw[9]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports {vgaBlueIn[2] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports {vgaBlueIn[3] }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports {vgaBlueIn[3] }]; #IO_L24P_T3_35 Sch=sw[12]
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { buttonsMove }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { camera_configured }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
##Buttons
#set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { resend }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
...
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { nexys_power }]; #IO_0_15 Sch=jb[9]
#set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[2] }]; #IO_L13P_T2_MRCC_15 Sch=jb[10]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {stm_pclk_IBUF}];
...
##Pmod Header JXADC
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { Hsync }]; #IO_L9P_T1_DQS_AD3P_15 Sch=xa_p[1]
#set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L9N_T1_DQS_AD3N_15 Sch=xa_n[1]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { Vsync }]; #IO_L8N_T1_AD10N_15 Sch=xa_n[2]
#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { XA_P[2] }]; #IO_L8P_T1_AD10P_15 Sch=xa_p[2]
#set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L7N_T1_AD2N_15 Sch=xa_n[3]
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { clk_out_25MHz }]; #IO_L7P_T1_AD2P_15 Sch=xa_p[3]
...
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { vga_vsync }]; #IO_L4P_T0_15 Sch=vga_hs
set_property -dict { PACKAGE_PIN B12   IOSTANDARD LVCMOS33 } [get_ports { vga_hsync }]; #IO_L3N_T0_DQS_AD1N_15 Sch=vga_vs
